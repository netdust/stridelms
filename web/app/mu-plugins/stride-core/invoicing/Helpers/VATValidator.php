 ...
 * Hook registration should be done by the calling service.
 *
...
class VATValidator
{
    ...
    /**
     * Re-validate a previously fail-opened VAT number
     *
     * Called by QuoteService via Action Scheduler hook.
     *
     * @param string $vatNumber The VAT number to re-validate
     */
