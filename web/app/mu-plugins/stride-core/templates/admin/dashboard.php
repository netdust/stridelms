...
<div class="wrap sd-app" x-data="strideApp()" x-cloak>
    ...
    <div class="sd-content">
        ...
        <!-- ========================================================
             VIEW: TRAJECTEN (Surface 4 — Task 3.6)
             Read-only overview + detail slide-over + "Toon inschrijvingen"
             jump (reuses the A2 gridFilters.trajectory_id child-row filter).
             ======================================================== -->
        <?php include __DIR__ . '/dashboard/trajecten.php'; ?>
    ...
    <?php include __DIR__ . '/dashboard/dossier.php'; ?>
