...
use StellarWP\Learndash\LiquidWeb\Harbor\Licensing\Error_Code;
use StellarWP\Learndash\LiquidWeb\Harbor\Utils\License_Key;
use StellarWP\Learndash\LiquidWeb\Harbor\Licensing\License_Manager;
use StellarWP\Learndash\LiquidWeb\Harbor\Licensing\Product_Collection;
use StellarWP\Learndash\LiquidWeb\Harbor\Site\Data;
use WP_Error;
...
final class License_Controller extends WP_REST_Controller {
		...
		register_rest_route(
			...
			[
				[
					...
					'args'                => [
						'key' => [
							'description'       => __( 'The license key to look up.', 'learndash' ),
							'type'              => 'string',
							'required'          => true,
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'key'      => [
					'description' => __( 'The unified license key.', 'learndash' ),
					'type'        => [ 'string', 'null' ],
					'context'     => [ 'view' ],
				],
				'products' => [
					'description' => __( 'The products associated with the license key.', 'learndash' ),
					'type'        => 'array',
					'context'     => [ 'view' ],
					'items'       => [
						'type'       => 'object',
						'properties' => [
							'product_slug'      => [
								'description' => __( 'The product identifier.', 'learndash' ),
								'type'        => 'string',
							],
							'tier'              => [
								'description' => __( 'The entitlement tier.', 'learndash' ),
								'type'        => 'string',
							],
							'status'            => [
								'description' => __( 'The entitlement status.', 'learndash' ),
								'type'        => 'string',
							],
							'expires'           => [
								'description' => __( 'The expiration date.', 'learndash' ),
								'type'        => 'string',
								'format'      => 'date-time',
							],
							'activations'       => [
								'description' => __( 'Activation seat data.', 'learndash' ),
								'type'        => 'object',
								'properties'  => [
									'site_limit'   => [
										'description' => __( 'Maximum activation seats (0 = unlimited).', 'learndash' ),
										'type'        => 'integer',
									],
									'active_count' => [
										'description' => __( 'Current active activations.', 'learndash' ),
										'type'        => 'integer',
									],
									'over_limit'   => [
										'description' => __( 'Whether the seat limit is exceeded.', 'learndash' ),
										'type'        => 'boolean',
									],
									'domains'      => [
										'description' => __( 'Activated domain names.', 'learndash' ),
										'type'        => 'array',
										'items'       => [ 'type' => 'string' ],
									],
								],
							...
							'capabilities'      => [
								'description' => __( 'Feature slugs granted by this entitlement.', 'learndash' ),
								'type'        => 'array',
								'items'       => [ 'type' => 'string' ],
							],
							'activated_here'    => [
								'description' => __( 'Whether the product is activated on this domain.', 'learndash' ),
								'type'        => [ 'boolean', 'null' ],
							],
							'validation_status' => [
								'description' => __( 'The validation status for this product.', 'learndash' ),
								'type'        => [ 'string', 'null' ],
							],
							'is_valid'          => [
								'description' => __( 'Whether the product has a valid license.', 'learndash' ),
								'type'        => 'boolean',
							],
						],
					],
				...
				'error'    => [
					'description' => __( 'An error encountered while fetching the license, or null if none.', 'learndash' ),
					'type'        => [ 'object', 'null' ],
					'context'     => [ 'view' ],
					'properties'  => [
						'code'    => [
							'description' => __( 'The error code.', 'learndash' ),
							'type'        => 'string',
						],
						'message' => [
							'description' => __( 'The error message.', 'learndash' ),
							'type'        => 'string',
						],
					],
				],
	...
	private function get_store_args(): array {
		return array_merge(
			[
				'key' => [
					'description'       => __( 'The license key to store.', 'learndash' ),
					'type'              => 'string',
					'required'          => true,
	...
	private function get_network_args(): array {
		return [
			'network' => [
				'description' => __( 'Whether to operate on the network-level key (multisite only).', 'learndash' ),
				'type'        => 'boolean',
				'default'     => false,
			],
		];
