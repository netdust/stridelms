...
class Service_Strategy extends Abstract_Strategy {
	...
	public function enable() {
		return new WP_Error(
			...
			sprintf(
				...
				__( '"%s" is a service feature and cannot be enabled here. To manage this feature, visit the Commerce Portal.', 'learndash' ),
	...
	public function disable() {
		return new WP_Error(
			...
			sprintf(
				/* translators: %s: feature name */
				__( '"%s" is a service feature and cannot be disabled here. To manage this feature, visit the Commerce Portal.', 'learndash' ),
				$this->feature->get_name()
			)
		);
	}
	...
	public function update() {
		return new WP_Error(
			...
			sprintf(
				/* translators: %s: feature name */
				__( '"%s" is a service feature and does not have updates. To manage this feature, visit the Commerce Portal.', 'learndash' ),
				$this->feature->get_name()
			)
		);
	}
