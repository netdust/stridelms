...
namespace StellarWP\Learndash\LiquidWeb\Harbor\Admin;
...
use StellarWP\Learndash\LiquidWeb\Harbor\Utils\Version;
/**
...
class Feature_Manager_Page
{
    ...
    public function maybe_register_page(): void
    {
        ...
        $this->page_hook = (string) add_submenu_page('options-general.php', __('Liquid Web Software Manager', 'learndash'), __('Liquid Web Products', 'learndash'), 'manage_options', self::PAGE_SLUG, [$this, 'render']);
        /**
    ...
    private function enqueue_assets(): void
    {
        ...
        wp_set_script_translations($handle, 'learndash');
