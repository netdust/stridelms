...
final class Catalog_Controller extends WP_REST_Controller {
	...
	public function get_item_schema(): array {
		...
		$this->schema = [
			...
			'properties' => [
				'product_id'   => [
					'description' => __( 'The product ID from the Commerce Portal.', 'learndash' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'product_slug' => [
					'description' => __( 'The product slug.', 'learndash' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'product_name' => [
					'description' => __( 'The product display name.', 'learndash' ),
					'type'        => 'string',
					'readonly'    => true,
					'context'     => [ 'view' ],
				],
				'tiers'        => [
					'description' => __( 'The product tiers ordered by rank.', 'learndash' ),
					'type'        => 'array',
					'readonly'    => true,
					'context'     => [ 'view' ],
					'items'       => [
				...
				'features'     => [
					'description' => __( 'The product features.', 'learndash' ),
					'type'        => 'array',
					'readonly'    => true,
					'context'     => [ 'view' ],
					'items'       => [
