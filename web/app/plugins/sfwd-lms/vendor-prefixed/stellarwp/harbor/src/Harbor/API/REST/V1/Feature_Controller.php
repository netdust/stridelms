...
namespace StellarWP\Learndash\LiquidWeb\Harbor\API\REST\V1;

use StellarWP\Learndash\LiquidWeb\Harbor\Features\Error_Code;
use StellarWP\Learndash\LiquidWeb\Harbor\Features\Feature_Resource;
use StellarWP\Learndash\LiquidWeb\Harbor\Features\Manager;
use StellarWP\Learndash\LiquidWeb\Harbor\Features\Types\Feature;
use StellarWP\Learndash\LiquidWeb\Harbor\Utils\Cast;
use WP_Error;
...
class Feature_Controller extends WP_REST_Controller {
	...
	public function get_item_schema(): array {
		...
		$base_properties = [
			'slug'              => [
				'description' => __( 'The feature slug.', 'learndash' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'name'              => [
				'description' => __( 'The feature display name.', 'learndash' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'description'       => [
				'description' => __( 'The feature description.', 'learndash' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'product'           => [
				'description' => __( 'The product the feature belongs to.', 'learndash' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'tier'              => [
				'description' => __( 'The feature tier.', 'learndash' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'type'              => [
				'description' => __( 'The feature type identifier.', 'learndash' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'is_available'      => [
				'description' => __( 'Whether the feature is available for the current site.', 'learndash' ),
				'type'        => 'boolean',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'in_catalog_tier'   => [
				'description' => __( "True when the user's licensed tier covers this feature's minimum tier.", 'learndash' ),
				'type'        => 'boolean',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'documentation_url' => [
				'description' => __( 'The URL to the feature documentation.', 'learndash' ),
				'type'        => 'string',
				'format'      => 'uri',
				'readonly'    => true,
				'context'     => [ 'view' ],
			...
			'is_enabled'        => [
				'description' => __( 'Whether the feature is currently enabled.', 'learndash' ),
				'type'        => 'boolean',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
		...
		$installable_properties = [
			'release_date'      => [
				'description' => __( 'Release date of the latest version, or null if not applicable.', 'learndash' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'version'           => [
				'description' => __( 'Latest available version from the catalog, or null. Only present for installable features.', 'learndash' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'changelog'         => [
				'description' => __( 'Changelog HTML for the latest version, or null. Only present for installable features.', 'learndash' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'wporg_slug'        => [
				'description' => __( 'The WordPress.org slug for plugins_api() lookups, or null if not on WordPress.org.', 'learndash' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'installed_version' => [
				'description' => __( 'The currently installed version, or null if not installed.', 'learndash' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
			'update_version'    => [
				'description' => __( 'Version available in the WordPress update transient, or null when no update is pending.', 'learndash' ),
				'type'        => [ 'string', 'null' ],
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
		...
		$plugin_properties = [
			'plugin_file' => [
				'description' => __( 'The plugin file path relative to the plugins directory.', 'learndash' ),
				'type'        => 'string',
				'readonly'    => true,
				'context'     => [ 'view' ],
			],
	...
	public function get_collection_params(): array {
		return [
			'product'   => [
				'description'       => __( 'Filter by product.', 'learndash' ),
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
			],
			'tier'      => [
				'description'       => __( 'Filter by feature tier.', 'learndash' ),
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
			],
			'available' => [
				'description' => __( 'Filter by availability.', 'learndash' ),
				'type'        => 'boolean',
			],
			'type'      => [
				'description'       => __( 'Filter by feature type.', 'learndash' ),
				'type'              => 'string',
				'sanitize_callback' => 'sanitize_text_field',
			],
		];
