...
final class WPDataConnector extends DataConnector
{
    ...
    {
        $this->platformRepo = $platformRepo ?? ntdst_get(PlatformRepository::class);
    ...
    public function loadPlatform(Platform $platform): bool
    {
        ...
        // RSA public key for direct JWT verification (preferred over JWKS fetch)
        $platform->rsaKey = $post->fields['rsa_key'] ?? '';
        $platform->kid = $post->fields['kid'] ?? '';
    ...
    public function savePlatform(Platform $platform): bool
    {
        ...
        do_action('netdust_lti_platform_registered', $result, $platform);
    ...
    // ========================================================================
    // Context methods (using Data Manager field on platform CPT)
    // ========================================================================
