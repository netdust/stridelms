 ...
 *
 * Shows user's quotes as collapsible cards (same pattern as course cards).
 *
 * @param array $args {
                ...
                ?>
                    <div class="card" x-data="expandable(<?php echo $i === 0 ? 'true' : 'false'; ?>)">
                        ...
                        <button type="button"
                                ...
                                @click="toggle()">
                            <div class="w-14 h-14 rounded bg-primary/10 flex items-center justify-center shrink-0">
                                <?php echo stridence_icon('file-text', 'w-6 h-6 text-primary'); ?>
                            </div>
                                ...
                                <div class="flex flex-wrap gap-3 pt-2" x-data="{ moreOpen: false }">
                                    ...
                                    <?php if ($hasSecondClick) : ?>
                                        <button type="button"
                                            ...
                                            <?php echo stridence_icon('edit-2', 'w-4 h-4 mr-1'); ?>
                                    ...
                                    <?php if ($canCancel) : ?>
                                        <div x-data="confirmAction()">
                                            <button type="button"
                                                    x-show="!confirming"
                                                    @click="startConfirm()"
                                                    class="btn-ghost text-sm text-error hover:bg-error/10">
