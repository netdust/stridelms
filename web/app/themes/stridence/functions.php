...
require_once STRIDENCE_DIR . '/helpers/trajectory-meta.php';
...
require_once __DIR__ . '/services/frontend/CatalogEndpoint.php';
...
(new \stridence\services\frontend\CatalogEndpoint())->register();
