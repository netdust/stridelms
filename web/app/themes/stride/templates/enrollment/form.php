 ...
 * - Sidebar: Course details and price summary
 *
 * @package stride
 */
...
// Get edition from query parameter
    ...
    <div class="stride-enrollment uk-width-xlarge uk-margin-auto">
        <div class="stride-card uk-text-center uk-padding-large">
            ...
            <p class="uk-text-muted uk-margin-bottom">
                <?php esc_html_e('Je moet ingelogd zijn om je in te schrijven voor een cursus.', 'stride'); ?>
            </p>
            <a href="<?php echo esc_url(wp_login_url(add_query_arg('edition', $editionId, home_url('/inschrijven/')))); ?>" class="uk-button uk-button-primary uk-button-large">
...
if (!$editionId) {
    ...
    <div class="stride-enrollment uk-width-xlarge uk-margin-auto">
        <div class="stride-card uk-text-center uk-padding-large">
            ...
            <h2><?php esc_html_e('Geen cursus geselecteerd', 'stride'); ?></h2>
            <p class="uk-text-muted uk-margin-bottom">
                <?php esc_html_e('Selecteer eerst een cursus om je in te schrijven.', 'stride'); ?>
            </p>
...
if ($enrollmentService->isEnrolled($userId, $editionId)) {
    ?>
    <div class="stride-enrollment uk-width-xlarge uk-margin-auto">
        <div class="stride-card uk-text-center uk-padding-large">
            <div class="stride-empty-state__icon uk-margin-bottom">
...
// Check if can enroll
if (!$editionService->canEnroll($editionId)) {
    ?>
    <div class="stride-enrollment uk-width-xlarge uk-margin-auto">
        <div class="stride-card uk-text-center uk-padding-large">
            <div class="stride-empty-state__icon uk-margin-bottom">
...
// Pricing
$price = $editionService->getPrice($editionId, true); // Member price
...
<div class="stride-enrollment">
    ...
    <header class="stride-page-header uk-margin-bottom">
        <a href="<?php echo esc_url(get_permalink($editionId)); ?>" class="stride-page-header__back">
    ...
    <div uk-grid class="uk-grid-large">
        ...
        <div class="uk-width-2-3@m">
            <form id="stride-enrollment-form" method="post" class="stride-enrollment-form">
                ...
                <input type="hidden" name="edition_id" value="<?php echo esc_attr($editionId); ?>">
        ...
        <!-- Sidebar: Course Details & Price Summary -->
                ...
                <div class="stride-course-info-card">
                    <?php if ($heroImage): ?>
                        <div class="stride-course-info-image">
                            <img src="<?php echo esc_url($heroImage); ?>" alt="<?php echo esc_attr($courseTitle); ?>">
                        </div>
                    <?php endif; ?>

                    <div class="stride-course-info-header">
                        <h3 class="stride-course-info-title"><?php echo esc_html($courseTitle); ?></h3>
                    </div>
                            ...
                            <?php if ($sessionCount > 0): ?>
                                <li class="stride-course-info-item">
                                    ...
                                    <span>
                                        ...
                                        <?php if ($dayCount > 0 && $dayCount !== $sessionCount): ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="uk-text-right uk-text-muted" id="tax-amount"><?php
                                        ...
                                        echo '€ ' . number_format($taxAmount / 100, 2, ',', '.');
                                    ?></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr class="uk-text-bold" style="font-size: 1.1em;">
                                    ...
                                    <td class="uk-text-right" id="total-amount"><?php
                                        ...
                                        echo '€ ' . number_format($totalAmount / 100, 2, ',', '.');
                                    ?></td>
                                </tr>
                            </tfoot>
                        </table>
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (data.data.redirect_url) {
                        ...
                        window.location.href = '<?php echo esc_url(home_url('/mijn-account/mijn-cursussen/')); ?>?enrolled=1';
                    }
                } else {
                    UIkit.notification({
