...
if (have_posts()) :
    while (have_posts()) :
        ...
        // Get venue from edition meta or first in-person session
                    ...
                    <div class="stride-course-info-card">
                        ...
                        <div class="stride-course-info-body">
                            ...
                            <?php elseif ($isEnrolled): ?>
                                ...
                                <a href="<?php echo esc_url(home_url('/mijn-account/mijn-cursussen/')); ?>" class="stride-course-action-btn uk-button uk-button-default">
