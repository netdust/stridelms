...
## B. Phase 3 Tail — Quote/Invoice (P0)

**Source:** `plans/finish-phase-3.md`
**Why P0:** Belgian invoicing compliance + customer-facing edit restriction.

- [ ] Quote auto-lock cron — locks quotes 14 days before edition start (Action Scheduler)
- [ ] Billing edit restriction — `canUserEditQuote()` blocks edits within 14-day window
- [ ] OGM payment reference — Belgian `+++NNN/NNNN/NNNCC+++` generator + ExactOnline export column + storage on quote creation
- [ ] Tests for all three
